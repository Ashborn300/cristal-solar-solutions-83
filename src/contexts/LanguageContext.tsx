...
const translations = {
  fr: {
    ...
    'projects.subtitle': 'Excellence & Innovation',
    'projects.description': 'Découvrez quelques-unes de nos réalisations marquantes qui témoignent de notre expertise et de notre engagement envers l\'excellence.',
    ...
    'testimonials.subtitle': 'nos clients',
    'testimonials.description': 'La satisfaction de nos clients est notre plus belle récompense. Découvrez leurs retours d\'expérience.',

    // Statistics
    'stats.badge': 'Nos Performances',
    'stats.title': 'En Chiffres',
    'stats.subtitle': 'Notre Impact',
    'stats.description': 'Des résultats concrets qui témoignent de notre expertise et de notre engagement.',
    'stats.years': 'Années d\'expertise',
    'stats.projects': 'Projets réalisés',
    'stats.clients': 'Clients satisfaits',
    'stats.capacity': 'MW installés',

    // Leadership
    'leadership.badge': 'Direction',
    'leadership.title': 'Notre Équipe',
    'leadership.subtitle': 'Dirigeante',
    'leadership.description': 'Rencontrez l\'équipe dirigeante qui porte la vision et les valeurs de CRISTAL ALTERNATIVE ENGINEERING.',

    // FAQ
    'faq.badge': 'FAQ',
    'faq.title': 'Questions',
    'faq.subtitle': 'Fréquentes',
    'faq.description': 'Trouvez rapidement les réponses à vos questions les plus courantes sur nos services et l\'énergie solaire.',
    'faq.question1': 'Combien coûte une installation solaire à Kinshasa ?',
    'faq.answer1': 'Le coût varie selon vos besoins (5kW résidentiel: 8000-12000$, 25kW commercial: 30000-45000$). Nous proposons un devis gratuit personnalisé et des solutions de financement flexibles. L\'investissement est généralement rentabilisé en 2-4 ans grâce aux économies d\'électricité.',
    'faq.question2': 'Quelle est la durée de vie des panneaux solaires ?',
    'faq.answer2': 'Nos panneaux solaires ont une garantie de 25 ans et une durée de vie de 30+ ans. Les onduleurs sont garantis 10-15 ans. Nous proposons des contrats de maintenance pour optimiser les performances sur le long terme. La technologie photovoltaïque actuelle est très fiable.',
    'faq.question3': 'Le système fonctionne-t-il pendant la saison des pluies ?',
    'faq.answer3': 'Absolument ! Même par temps nuageux, les panneaux produisent 20-40% de leur capacité. Nos systèmes hybrides incluent des batteries pour stocker l\'énergie et assurer une alimentation continue. La pluie nettoie également les panneaux naturellement.',
    'faq.question4': 'Proposez-vous un service de maintenance ?',
    'faq.answer4': 'Oui, nous offrons un service de maintenance complet : nettoyage des panneaux, vérification des connexions, monitoring des performances, remplacement des pièces défectueuses. Contrats annuels disponibles avec intervention d\'urgence 24h/7j.',
    'faq.question5': 'Puis-je revendre l\'électricité excédentaire ?',
    'faq.answer5': 'Avec les systèmes on-grid, l\'excédent peut être injecté dans le réseau SNEL. Nous vous accompagnons dans les démarches administratives. Pour les systèmes hybrides, l\'excédent charge les batteries pour utilisation nocturne.',
    'faq.question6': 'Quelles sont les autorisations nécessaires ?',
    'faq.answer6': 'Nous nous occupons de toutes les démarches : permis de construire (si nécessaire), autorisation SNEL pour l\'injection réseau, certification technique. Notre expérience de 14 ans facilite ces procédures administratives.',
    'faq.contactTitle': 'Vous avez d\'autres questions ?',
    'faq.contactDescription': 'Notre équipe d\'experts est à votre disposition pour répondre à toutes vos questions et vous accompagner dans votre projet d\'énergie solaire.',

    // Contact
    'contact.badge': 'Contact',
    'contact.title': 'Parlons de',
    'contact.subtitle': 'votre projet',
    'contact.description': 'Prêt à passer à l\'énergie solaire ? Contactez-nous pour une consultation gratuite et découvrez comment nous pouvons vous aider.',
    'contact.form.title': 'Demande de devis',
    'contact.form.name': 'Nom complet',
    'contact.form.email': 'Adresse email',
    'contact.form.phone': 'Numéro de téléphone',
    'contact.form.project': 'Type de projet',
    'contact.form.project.residential': 'Résidentiel',
    'contact.form.project.commercial': 'Commercial',
    'contact.form.project.industrial': 'Industriel',
    'contact.form.project.agricultural': 'Agricole',
    'contact.form.project.other': 'Autre',
    'contact.form.message': 'Description de votre projet',
    'contact.form.messagePlaceholder': 'Décrivez-nous votre projet, vos besoins en énergie, et toute information qui nous aiderait à mieux vous conseiller...',
    'contact.form.submit': 'Envoyer la demande',
    'contact.form.success': 'Votre demande a été envoyée ! Nous vous répondrons rapidement.',
    'contact.info.title': 'Informations de contact',
    'contact.info.quickContact': 'Contact rapide',
    ...
    'contact.hours.weekdaysTime': '08h00 - 17h00',
    'contact.hours.saturday': 'Samedi',
    'contact.hours.saturdayTime': '08h00 - 13h00',
    ...
    'contact.map.address': '32, Avenue Kabale, Q/Tshimanga, C/ Barumbu, Kinshasa-RDC',
    'contact.map.viewOnMaps': 'Voir sur Google Maps',

    // Company Info
    'company.since': 'Depuis 2010',
    'company.tagline': 'Electricity and life anywhere',
    'company.address': 'Adresse',
    'company.phone': 'Téléphone',
    'company.email': 'E-mail',
    'company.legal': 'Informations légales',

    // Attestations
    'attestations.badge': 'Certifications',
    'attestations.title': 'Nos Attestations',
    'attestations.subtitle': 'Qualité Certifiée',
    'attestations.description': 'Découvrez nos certifications et attestations qui garantissent la qualité de nos services et notre expertise technique.',
    'attestations.viewButton': 'Voir nos attestations',

    // Gallery
    'gallery.title': 'Galerie de nos Réalisations',
    'gallery.description': 'Découvrez nos installations solaires à travers le Congo. Chaque projet raconte une histoire de transition énergétique réussie.',
  ...
  en: {
    ...
    'projects.subtitle': 'Excellence & Innovation',
    'projects.description': 'Discover some of our outstanding achievements that demonstrate our expertise and commitment to excellence.',
    ...
    'testimonials.description': 'Our clients\' satisfaction is our greatest reward. Discover their feedback.',

    // Statistics
    'stats.badge': 'Our Performance',
    'stats.title': 'In Numbers',
    'stats.subtitle': 'Our Impact',
    'stats.description': 'Concrete results that testify to our expertise and commitment.',
    'stats.years': 'Years of expertise',
    'stats.projects': 'Completed projects',
    'stats.clients': 'Satisfied clients',
    'stats.capacity': 'MW installed',

    // Leadership
    'leadership.badge': 'Leadership',
    'leadership.title': 'Our Leadership',
    'leadership.subtitle': 'Team',
    'leadership.description': 'Meet the leadership team that carries the vision and values of CRISTAL ALTERNATIVE ENGINEERING.',

    // FAQ
    'faq.badge': 'FAQ',
    'faq.title': 'Frequently',
    'faq.subtitle': 'Asked Questions',
    'faq.description': 'Quickly find answers to your most common questions about our services and solar energy.',
    'faq.question1': 'How much does a solar installation cost in Kinshasa?',
    'faq.answer1': 'Cost varies according to your needs (5kW residential: $8000-12000, 25kW commercial: $30000-45000). We offer free personalized quotes and flexible financing solutions. Investment is generally recovered in 2-4 years through electricity savings.',
    'faq.question2': 'What is the lifespan of solar panels?',
    'faq.answer2': 'Our solar panels have a 25-year warranty and a 30+ year lifespan. Inverters are guaranteed 10-15 years. We offer maintenance contracts to optimize long-term performance. Current photovoltaic technology is very reliable.',
    'faq.question3': 'Does the system work during the rainy season?',
    'faq.answer3': 'Absolutely! Even in cloudy weather, panels produce 20-40% of their capacity. Our hybrid systems include batteries to store energy and ensure continuous power supply. Rain also naturally cleans the panels.',
    'faq.question4': 'Do you offer maintenance service?',
    'faq.answer4': 'Yes, we offer complete maintenance service: panel cleaning, connection verification, performance monitoring, replacement of defective parts. Annual contracts available with 24/7 emergency intervention.',
    'faq.question5': 'Can I sell excess electricity?',
    'faq.answer5': 'With on-grid systems, excess can be injected into the SNEL network. We help you with administrative procedures. For hybrid systems, excess charges batteries for nighttime use.',
    'faq.question6': 'What authorizations are needed?',
    'faq.answer6': 'We handle all procedures: building permit (if necessary), SNEL authorization for grid injection, technical certification. Our 14 years of experience facilitates these administrative procedures.',
    'faq.contactTitle': 'Have other questions?',
    'faq.contactDescription': 'Our team of experts is at your disposal to answer all your questions and support you in your solar energy project.',

    // Contact
    'contact.badge': 'Contact',
    'contact.title': 'Let\'s talk about',
    'contact.subtitle': 'your project',
    'contact.description': 'Ready to switch to solar energy? Contact us for a free consultation and discover how we can help you.',
    ...
    'contact.form.project.agricultural': 'Agricultural',
    'contact.form.project.other': 'Other',
    'contact.form.message': 'Project description',
    'contact.form.messagePlaceholder': 'Tell us about your project, your energy needs, and any information that would help us advise you better...',
    'contact.form.submit': 'Send request',
    'contact.form.success': 'Your request has been sent! We will respond quickly.',
    'contact.info.title': 'Contact information',
    'contact.info.quickContact': 'Quick contact',
    ...
    'contact.hours.weekdaysTime': '08:00 AM - 05:00 PM',
    'contact.hours.saturday': 'Saturday',
    'contact.hours.saturdayTime': '08:00 AM - 01:00 PM',
    'contact.hours.sunday': 'Sunday',
    'contact.hours.sundayTime': 'Closed',
    'contact.legal.title': 'Legal information',
    'contact.map.title': 'Our location',
    'contact.map.address': '32, Avenue Kabale, Q/Tshimanga, C/ Barumbu, Kinshasa-DRC',
    'contact.map.viewOnMaps': 'View on Google Maps',

    // Company Info
    'company.since': 'Since 2010',
    'company.tagline': 'Electricity and life anywhere',
    'company.address': 'Address',
    'company.phone': 'Phone',
    'company.email': 'Email',
    'company.legal': 'Legal information',

    // Attestations
    'attestations.badge': 'Certifications',
    'attestations.title': 'Our Certifications',
    'attestations.subtitle': 'Certified Quality',
    'attestations.description': 'Discover our certifications and attestations that guarantee the quality of our services and our technical expertise.',
    'attestations.viewButton': 'View our certifications',

    // Gallery
    'gallery.title': 'Gallery of our Achievements',
    'gallery.description': 'Discover our solar installations throughout Congo. Each project tells a story of successful energy transition.',
